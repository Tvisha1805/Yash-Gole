...
export default function GalleryPage() {
  const allVideos = [
    ...
    { src: "/video2.mp4", title: "Crowd Work: The Auditor", subtitle: "Dubai Opera House" },
    { src: "/video3.mp4", title: "The Pivot Realized", subtitle: "London Short Tour" },
    { src: "/video4.mp4", title: "When Tech Fails", subtitle: "Pune Tech Fest" },
    { src: "/video5.mp4", title: "Marriage vs Engineering", subtitle: "Delhi Comedy Club" },
    { src: "/video6.mp4", title: "The HR Negotiation", subtitle: "Corporate Gig - Bangalore" },
    { src: "/video7.mp4", title: "Parents at the Show", subtitle: "Pune Local Set" },
    { src: "/video8.mp4", title: "Why I Hate LinkedIn", subtitle: "Live from Mumbai Special" },
  ];

  return (
    <div className="min-h-screen bg-[#050505] pt-28 md:pt-36 pb-24 px-6 md:px-12 relative overflow-hidden">
