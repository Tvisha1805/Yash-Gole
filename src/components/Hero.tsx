...
export default function Hero() {
  ...
  return (
    <section className="relative w-full min-h-[calc(100vh-88px)] flex flex-col items-center justify-center md:items-end md:justify-center py-20 overflow-hidden bg-[#0A0A0A]">
