...
export default function BookingSection() {
  ...
  const EMAIL = "bookings@yashgole.com";
          ...
          <div className="flex flex-col gap-4 mb-10">
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm font-bold text-white group-hover:text-[#25D366] transition-colors">Message Directly</p>
              </div>
            </a>
            ...
            <div className="flex items-center gap-4 p-4 border border-white/8 bg-white/[0.02]">
              ...
              <div>
                ...
                <p className="text-sm font-bold text-white">Mumbai, International Tours</p>
              </div>
            </div>
          </div>
